...
contract OGIOToken is ERC20Token, Owned {

    string  public constant name = "OGIO Token";
    string  public constant symbol = "OGIO";
    uint256 public constant decimals = 18;
    uint256 public tokenDestroyed;
    event Burn(address indexed _from, uint256 _tokenDestroyed, uint256 _timestamp);

    function OGIOToken() public {
    ...
    function burn (uint256 _burntAmount) public payable returns (bool success) {
